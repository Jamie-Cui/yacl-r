...
ExternalProject_Add(
  ...
  COMMAND cp -n ${CMAKE_DEPS_PREFIX}/lib/libmcl${CMAKE_STATIC_LIBRARY_SUFFIX}
          ${CMAKE_DEPS_LIBDIR}
  COMMAND
    cp -n ${CMAKE_DEPS_PREFIX}/lib/libmclbn256${CMAKE_STATIC_LIBRARY_SUFFIX}
    ${CMAKE_DEPS_LIBDIR}
  COMMAND
    cp -n ${CMAKE_DEPS_PREFIX}/lib/libmclbn384${CMAKE_STATIC_LIBRARY_SUFFIX}
    ${CMAKE_DEPS_LIBDIR}
