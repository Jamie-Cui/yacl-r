...
#include "yacl/snark/r1cs.h"

#include "yacl/utils/exception.h"

namespace yacl::snark {
...
math::MPInt LinearCombination::Evaluate(const std::vector<math::MPInt>& witness,
...
bool R1csSystem::IsSatisfied(const std::vector<math::MPInt>& witness,
  ...
  YACL_ENFORCE(static_cast<int64_t>(witness.size()) == num_variables_,
               ...
               num_variables_);
  YACL_ENFORCE(witness[0].IsOne(), "Witness[0] must be 1 (constant wire)");
