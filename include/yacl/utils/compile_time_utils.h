...
// ---------------------------
// CRC32 is a checksum algorithm that hashes byte sequences to 32 bit values
// (note this is not cryptographically secure hash), for more information,
// please check:
// 1. https://en.wikipedia.org/wiki/Cyclic_redundancy_check
// 2. https://web.mit.edu/freebsd/head/sys/libkern/crc32.c
//
...
// recursively iterate each char to calculate CRC hash
template <size_t idx>
constexpr uint32_t crc32(const char* str) {
  return (crc32<idx - 1>(str) >> 8) ^
         crc32_table[(crc32<idx - 1>(str) ^ str[idx]) & 0x000000FF];
}
...
// ----------------------------------------
// the following code was found at: https://stackoverflow.com/a/6174263
//
// /* TO-USE */
// 1. struct CustomizedCtr {};     // init counter = 0
// 2. COUNTER_INC(CustomizedCtr);  // counter ++
// 3. COUNTER_READ(CustomizedCtr); // read counter

// holds a static constant size_t integar n
